// CV
const String resume =
    'https://drive.google.com/file/d/1JRZKzk62Rmz_RKO8O6ie374PuWTNoV7C/view?usp=drive_link';

// Github Link
const String gitHub = 'https://github.com/shriiix';
// Github Link
const String facebook = 'https://www.facebook.com/shridhar.ghadi.1';
// Github Link
const String twitter = 'https://twitter.com/shri_ghadi';
// Github Link
// const String youtube =
//     'https://www.youtube.com/channel/UCXooUY2oL_eqGhTaZn-ExSg';
// Github Link
const String linkedin = 'https://www.linkedin.com/in/shridhar-ghadi/';
// Github Link
// const String buymeacoffee = 'https://www.buymeacoffee.com/sudeshnb';
// Github Link
const String instagram = 'https://shorturl.at/jnpA3';
// socialLinks
